...
query_that_results_in_table_of_positive_indicators_for_Bipolar_disorder = """
    SELECT
        c_occurrence.visit_occurrence_id,
...
LEFT JOIN (""" + query_that_results_in_table_of_positive_indicators_for_Bipolar_disorder + """) table_of_positive_indicators_of_Bipolar_disorder
